...
public class DecimalUtilsTest {
    ...
    public void testPackLongs() {
        final Decimal[] longs = DecimalUtils.packLongs(23142341234123412L, 345235234523532453L,
                new Date().getTime());
    ...
    public void testPackLongList() {
        final List<Decimal> longs = DecimalUtils.packLongList(23142341234123412L,
    ...
    public void testASetOfDecimals() {
        final List<Decimal> doublesList = Arrays.asList(DecimalUtils.pack(1, 2, 1, 2, 3, 4, 3, 4,
                5, 6, 5, 6, 7, 8, 7, 8));
        final Set<Decimal> doublesSet = new TreeSet<Decimal>(doublesList);
        final Set<Decimal> intsSet = new TreeSet<Decimal>(Arrays.asList(DecimalUtils.packInts(1, 2,
                3, 4, 5, 6, 7, 8)));
