...
public class DecimalAgainstJavaNumbersTest {
    ...
    public void testShowASimpleChainingVersusBigDecimal() {
        final BigDecimal result = new BigDecimal(125.75).subtract(new BigDecimal(100)).add(
                new BigDecimal(4.25)).divide(new BigDecimal(3), new MathContext(2));
    ...
    public void testArrayCreation() {
        BigDecimal[] values = new BigDecimal[] { new BigDecimal("123.456"),
                new BigDecimal("5635.32353"), new BigDecimal("6754353.4234") };
