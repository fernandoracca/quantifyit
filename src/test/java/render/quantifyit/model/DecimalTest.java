...
public class DecimalTest {
	...
	final Decimal identicInt = firstElement.plus(Decimal.$(34.56789),
		new MathContext(5));
	final Decimal expected = Decimal.$(1234.6);
	assertEquals(0, expected.compareTo(identicInt));
	assertTrue(expected.same(identicInt));

	final Decimal identicDecimals = Decimal.$(654).plus(
		Decimal.$(46.321456789), new MathContext(6));
	...
	assertEquals("  45.000", String.format("%8.3f", Decimal.$(45)
		.asBigDecimal()));
    }
