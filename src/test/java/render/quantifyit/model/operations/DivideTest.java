...
public class DivideTest {
    ...
    public void testDivisionRoundedToInt() {
        final BigDecimal expected = new BigDecimal(312d).divide(new BigDecimal(7d),
    ...
    public void testDivisionWithScaling() {
        final BigDecimal expected = new BigDecimal(312d).divide(new BigDecimal(7d), 2,
    ...
    public void testCompareDivisionWithDefaultPrecision() {
        final BigDecimal expected = new BigDecimal(312d).divide(new BigDecimal(7d), 10,
                RoundingMode.HALF_EVEN);
    ...
    public void testShouldRoughlyApproximateToPi() {
        ...
        BigDecimal bigDecimalApproximation = new BigDecimal(223d).divide(new BigDecimal(71d),
                RoundingMode.HALF_EVEN);
        assertEquals(new BigDecimal(3), bigDecimalApproximation);

        bigDecimalApproximation = new BigDecimal(223d).divide(new BigDecimal(71d), 5,
                RoundingMode.HALF_EVEN);
    ...
    public void testShouldCloselyApproximateToPi() {
        ...
        BigDecimal bigDecimalApproximation = new BigDecimal(355d).divide(new BigDecimal(113d),
                RoundingMode.HALF_EVEN);
        assertEquals(new BigDecimal(3), bigDecimalApproximation);

        bigDecimalApproximation = new BigDecimal(355d).divide(new BigDecimal(113d), 7,
                RoundingMode.HALF_EVEN);
