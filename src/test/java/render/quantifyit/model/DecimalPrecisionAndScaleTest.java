...
public class DecimalPrecisionAndScaleTest {
	...
	assertAndOutputNumber(Decimal.$(number, context), new BigDecimal(
		number, context));
    }
	...
	System.out.format(msg.toString(), number.toSciString(), output, number
		.toEngString(), number.getPrecision(), number.getScale());
    }
    ...
    private void assertAndOutputNumber(final Decimal decimal,
