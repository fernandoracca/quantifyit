...
public class DecimalConstructorTest {
	...
	final BigDecimal bPositiveIntegerString = new BigDecimal(
		STRING_POSITIVE);
	final BigDecimal bmPositiveIntegerString = new BigDecimal(
		STRING_POSITIVE, new MathContext(3));
	final Decimal dPositiveIntegerString = Decimal.$(STRING_POSITIVE);
	final Decimal dmPositiveIntegerString = Decimal.$(STRING_POSITIVE,
		new MathContext(3));
	...
	assertEquals(bPositiveIntegerString, dPositiveIntegerString
		.asBigDecimal());
	assertEquals(INT_POSITIVE, dPositiveIntegerString.asInteger());
	assertEquals(bPositiveIntegerString.intValue(), dPositiveIntegerString
		.asInteger());
	assertEquals(DOUBLE_POSITIVE, dPositiveIntegerString.asDouble(), 0);
	assertEquals(bPositiveIntegerString.doubleValue(),
		dPositiveIntegerString.asDouble(), 0);

	assertEquals(bmPositiveIntegerString, dmPositiveIntegerString
		.asBigDecimal());
	assertEquals(12300, dmPositiveIntegerString.asInteger());
	assertEquals(bmPositiveIntegerString.intValue(),
		dmPositiveIntegerString.asInteger());
	assertEquals(12300d, dmPositiveIntegerString.asDouble(), 0);
	assertEquals(bmPositiveIntegerString.doubleValue(),
		dmPositiveIntegerString.asDouble(), 0);
    }

    @Test
    public void testThatNegativeIntegerDecimalsWithStringConstructorAreEquals() {
	final BigDecimal bNegativeIntegerString = new BigDecimal(
		STRING_NEGATIVE);
	final BigDecimal bmNegativeIntegerString = new BigDecimal(
		STRING_NEGATIVE, new MathContext(3));
	final Decimal dNegativeIntegerString = Decimal.$(STRING_NEGATIVE);
	final Decimal dmNegativeIntegerString = Decimal.$(STRING_NEGATIVE,
		new MathContext(3));
	...
	assertEquals(bNegativeIntegerString, dNegativeIntegerString
		.asBigDecimal());
	assertEquals(INT_NEGATIVE, dNegativeIntegerString.asInteger());
	assertEquals(bNegativeIntegerString.intValue(), dNegativeIntegerString
		.asInteger());
	assertEquals(DOUBLE_NEGATIVE, dNegativeIntegerString.asDouble(), 0);
	assertEquals(bNegativeIntegerString.doubleValue(),
		dNegativeIntegerString.asDouble(), 0);

	assertEquals(bmNegativeIntegerString, dmNegativeIntegerString
		.asBigDecimal());
	assertEquals(-12300, dmNegativeIntegerString.asInteger());
	assertEquals(bmNegativeIntegerString.intValue(),
		dmNegativeIntegerString.asInteger());
	assertEquals(-12300d, dmNegativeIntegerString.asDouble(), 0);
	assertEquals(bmNegativeIntegerString.doubleValue(),
		dmNegativeIntegerString.asDouble(), 0);
    }
	...
	assertEquals(bPositiveIntegerInt.intValue(), dPositiveIntegerInt
		.asInteger());
	assertEquals(DOUBLE_POSITIVE, dPositiveIntegerInt.asDouble(), 0);
	assertEquals(bPositiveIntegerInt.doubleValue(), dPositiveIntegerInt
		.asDouble(), 0);
    }
	...
	assertEquals(bNegativeIntegerInt.intValue(), dNegativeIntegerInt
		.asInteger());
	assertEquals(DOUBLE_NEGATIVE, dNegativeIntegerInt.asDouble(), 0);
	assertEquals(bNegativeIntegerInt.doubleValue(), dNegativeIntegerInt
		.asDouble(), 0);
    }
	...
	assertEquals(STRING_DECIMAL, Double.toString(doubleConstructor
		.doubleValue()));
	assertEquals(DOUBLE_POSITIVE, Double.valueOf(doubleConstructor
		.toString()), 0);
	...
	assertEquals("34534533.00000", Decimal.$(new BigDecimal(34534533), 5)
		.toString());
	assertEquals("456.000000001", Decimal.$(
		new BigDecimal(456.0000000005605), 9).toString());
	assertEquals("483934895393453453", Decimal.$(483934895393453453L)
		.toString());
    }
    ...
    private void assertEqualString(final BigDecimal expected,
