...
public class DispersionTest {
	...
	final Decimal varianceWithMean = Dispersion.sampleVariance(
		Decimal.$(4), elements);
	...
	final Decimal[] elements = pack(1, 2, 9);
	final Decimal variance = Dispersion.populationVariance(Decimal.$(4),
		elements);
	...
	final Decimal[] elements = new Decimal[] { oneHundredMillions.plus(4),
		oneHundredMillions.plus(7), oneHundredMillions.plus(13),
	...
	final Decimal sampleSD = Dispersion.sampleStandardDeviation(Decimal
		.$(6), elements);
	...
	final Decimal[] elements = pack(1, 2, 3, 4, 20);
	final Decimal populationSD = Dispersion.populationStandardDeviation(
		Decimal.$(6), elements);
	...
	final Decimal[] elements = pack(1, 2, 3, 4, 20);
	final Decimal populationSD = Dispersion
		.populationStandardDeviation(elements);
	assertDecimal(7.07, populationSD, 2);
    }
	...
	final Decimal[] elements = pack(2);
	final Decimal standardDeviation = Dispersion
		.sampleStandardDeviation(elements);
