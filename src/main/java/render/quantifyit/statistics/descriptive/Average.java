...
public final class Average {
    ...
    /**
     * The arithmetic mean (or simply the mean) of a list of numbers is the sum
     * of all of the list divided by the number of items in the list. Returns
     * NaN if 0 elements.
     * 
     * @param elements
     ...
     * unique, so one often takes the mean of the two middle values. At most
     * half the population have values less than the median and at most half
     ...
     * data set or a probability distribution.
     * 
     * @param elements
     * 
