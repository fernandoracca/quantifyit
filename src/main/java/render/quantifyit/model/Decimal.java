...
public class Decimal implements Comparable<Decimal>, Serializable {
     ...
     * default. "Note that this is the rounding mode that statistically
    ...
    /*
     * divideBy = Division = BigDecimal.divide(...) For maximum control use
     * Divide or subclasses.
     */
    ...
    /**
     * Honours the equals(Object) implementation of BigDecimal, which is prone
     * to errors, since Decimal.$(1).equals(Decimal.$(1d)) evaluates to false,
     * because 1d = 1.0 (10 with a scale of 1) Use
     * {@link render.quantifyit.model.Decimal#compareTo} instead.
     * 
     * Warning, collections that rely on equals ( and its evil twin hashCode),
     * such as HashSet and HashMap will fail the equality comparison.
     * Suggestions:
     * <ul>
     * <li>Do not use the double constructor/methods to compare against ints,
     * use more strict versions such as Decimal(String), although this still
     * won't guarantee equality if you do operations such as division</li>
     * <li>Avoid hash based collections, prefer instead those that use
     * Comparable/Comparator</li>
     * <li>To compare lists, use
     * {@link render.quantifyit.util.DecimalUtils#containsAll}</li>
     * </ul> {@link BigDecimal#equals(Object) equals(Object)}
     * 
     * 
