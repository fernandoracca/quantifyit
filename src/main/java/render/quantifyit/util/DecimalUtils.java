...
public final class DecimalUtils {
    ...
    public static boolean contains(final List<Decimal> source,
	    final Decimal target) {
	return contains(source.iterator(), target);
    }

    public static boolean containsAll(final List<Decimal> source,
	    final List<Decimal> target) {
    ...
    private static boolean contains(final Iterator<Decimal> sourceIterator,
	    final Decimal target) {
	if (target == null) {
